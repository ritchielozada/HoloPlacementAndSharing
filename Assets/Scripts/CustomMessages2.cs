...
namespace HoloToolkit.Sharing.Tests
{
    ...
    public class CustomMessages2 : Singleton<CustomMessages2>
    {
        ...
        /// </summary>
        public enum AppShareControlMessageID : byte
        {
        ...
        private Dictionary<AppShareControlMessageID, MessageCallback> messageHandlers = new Dictionary<AppShareControlMessageID, MessageCallback>();
        public Dictionary<AppShareControlMessageID, MessageCallback> MessageHandlers
        {
            get
            {
        ...
        private void InitializeMessageHandlers()
        {
            ...
            for (byte index = (byte)AppShareControlMessageID.HeadTransform; index < (byte)AppShareControlMessageID.Max; index++)
            {
                if (MessageHandlers.ContainsKey((AppShareControlMessageID)index) == false)
                {
                    MessageHandlers.Add((AppShareControlMessageID)index, null);
                }
        ...
        public void SendHeadTransform(Vector3 position, Quaternion rotation)
        {
            ...
            if (serverConnection != null && serverConnection.IsConnected())
            {
                ...
                NetworkOutMessage msg = CreateMessage((byte)AppShareControlMessageID.HeadTransform);
        ...
        private void OnMessageReceived(NetworkConnection connection, NetworkInMessage msg)
        {
            ...
            MessageCallback messageHandler = MessageHandlers[(AppShareControlMessageID)messageType];
        ...
        private void AppendString(NetworkOutMessage msg, string data)
        {
            msg.Write(new XString(data));
        }
