...
namespace HoloToolkit.Sharing.Tests
{
    ...
    /// </summary>
    public class RemoteHeadManager2 : Singleton<RemoteHeadManager2>
    {
        ...
        private void Start()
        {            
            CustomMessages2.Instance.MessageHandlers[CustomMessages2.AppShareControlMessageID.HeadTransform] = UpdateHeadTransform;
        ...
        private void Update()
        {
            ...
            CustomMessages2.Instance.SendHeadTransform(headPosition, headRotation);
        }
        ...
        private void UpdateHeadTransform(NetworkInMessage msg)
        {
            ...
            Vector3 headPos = CustomMessages2.Instance.ReadVector3(msg);

            Quaternion headRot = CustomMessages2.Instance.ReadQuaternion(msg);
        ...
        {
            // TODO: Use Head Tracking Avatar Model
            GameObject newHeadObj = Instantiate(HeadAvatar) as GameObject;
